        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-4xl font-semibold leading-[1.05] tracking-tight text-[var(--demo-paper)] sm:text-5xl">
              ...
              <span className="italic text-[var(--demo-gold)]">cada etapa.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-lg text-base leading-relaxed text-white/55 sm:text-lg">
              No necesitas saber qué especialidad buscar. Cuéntanos qué te pasa y
              te llevamos a la persona correcta.
            </p>
          </Reveal>
        </div>
