...
import { values, clinic } from "./content";

export function VitaTrust() {
  return (
        ...
        <div>
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-4xl font-semibold leading-[1.05] tracking-tight text-[var(--demo-paper)] sm:text-5xl">
              Cuando se trata de tu salud, saber quién te atiende{" "}
              <span className="italic text-[var(--demo-gold)]">importa.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-md text-base leading-relaxed text-white/55">
              Médicos identificables, precios publicados y una dirección a la que
              puedes llegar caminando. Así de simple.
            </p>
          </Reveal>
            ...
            <div className="overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.03]">
              ...
              <dl>
                <div className="flex items-start gap-4 border-b border-white/[0.07] px-7 py-5">
                  ...
                  <dd className="pt-1.5 text-sm leading-relaxed text-white/70">{clinic.address}</dd>
                </div>
                <div className="flex items-start gap-4 border-b border-white/[0.07] px-7 py-5">
                  <dt className="flex size-9 shrink-0 items-center justify-center rounded-full border border-[var(--demo-gold)]/25 text-[var(--demo-gold)]">
                ...
                <div className="flex items-start gap-4 border-b border-white/[0.07] px-7 py-5">
                  ...
                  <dd className="pt-1.5">
                    <a href={clinic.phoneHref} className="text-sm text-white/70 transition-colors hover:text-[var(--demo-gold)]">
                      {clinic.phone}
                    </a>
                  </dd>
                </div>
                <div className="flex items-start gap-4 border-b border-white/[0.07] px-7 py-5">
                  ...
                  <dd className="pt-1.5">
                    <a href={`mailto:${clinic.email}`} className="text-sm text-white/70 transition-colors hover:text-[var(--demo-gold)]">
                      {clinic.email}
                    </a>
                  </dd>
                </div>
                <div className="flex items-start gap-4 px-7 py-5">
                  ...
                  <dd className="pt-1.5">
                    <a href={clinic.whatsapp} className="text-sm text-white/70 transition-colors hover:text-[var(--demo-gold)]">
