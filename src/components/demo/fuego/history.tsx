...
const recordRows = [
  { label: "Maduración", value: "21 días" },
  { label: "Corte de hoy", value: "Ojo de bife" },
  { label: "Brasa", value: "Quebracho seco" },
  { label: "Punto de mesa", value: "Término medio" },
];

export function FuegoHistory() {
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-2xl sm:rounded-3xl">
              <Image
                ...
                alt="Parrillero cortando un corte de carne con cuchillo sobre tabla junto a la brasa"
                width={1400}
                height={1400}
                data-cursor="ver"
        ...
        <div>
          <Reveal>
            <p className="flex items-center gap-3 font-mono text-[11px] font-medium uppercase tracking-[0.28em] text-[var(--demo-accent-deep)]">
              ...
              Una historia de parrilla
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-[clamp(2.2rem,4.5vw,3.6rem)] font-semibold leading-[1.05] tracking-tight">
              El corte no empieza en la parrilla.{" "}
              <span className="italic text-[var(--demo-accent-deep)]">
                Empieza días antes, en la maduración.
              </span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-md text-base leading-relaxed text-[var(--demo-ink)]/70">
              Cada pieza que servimos madura en nuestra cava, se
              asienta en su tiempo y se asa sobre quebracho. Por eso
              el sabor no se repite: se mejora.
            </p>
          </Reveal>
            ...
            <div className="mt-10 overflow-hidden rounded-2xl border border-[var(--demo-ink)]/10 bg-white/60">
              <div className="flex items-center justify-between border-b border-[var(--demo-ink)]/10 px-6 py-4">
                <p className="font-demo-serif text-lg font-semibold tracking-tight">
                  FUEGO <span className="text-[var(--demo-ink)]/50">· La pieza de hoy</span>
                </p>
          ...
          <Reveal delay={0.35}>
            <p className="mt-4 font-mono text-[9px] uppercase tracking-[0.2em] text-[var(--demo-ink)]/35">
              Tablero de cocina · valores del día
            </p>
          </Reveal>
        </div>
      </DemoContainer>
