...
export function FuegoAcompanamiento() {
  return (
      ...
      <DemoContainer>
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-4xl font-semibold leading-[1.05] tracking-tight text-[var(--demo-paper)] sm:text-5xl">
              La mesa se queda contigo{" "}
              <span className="italic text-[var(--demo-gold)]">hasta el último trago.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-lg text-base leading-relaxed text-white/55 sm:text-lg">
              No servimos y desaparecemos. Nos quedamos hasta que
              tu noche se haya contado completa.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.2}>
          <p className="mt-8 font-mono text-[9px] uppercase tracking-[0.2em] text-white/30">
            Historias demostrativas · no son testimonios reales
          </p>
        </Reveal>
      </DemoContainer>
    </section>
