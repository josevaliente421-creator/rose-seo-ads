...
export function FuegoTimeline30() {
        ...
        <div className="max-w-3xl">
          <Reveal>
            <p className="flex items-center gap-3 font-mono text-[11px] font-medium uppercase tracking-[0.28em] text-[var(--demo-accent-deep)]">
              ...
              La comida lenta es un lujo
            </p>
          </Reveal>
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-[clamp(2.6rem,6vw,4.8rem)] font-semibold leading-[1.02] tracking-tight">
              La brasa no se apura.{" "}
              <span className="italic text-[var(--demo-accent-deep)]">Nosotros tampoco.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-7 max-w-xl text-base leading-relaxed text-[var(--demo-ink)]/70 sm:text-lg">
              No medimos una parrilla por cuántos platos salen por
              hora. La medimos por cómo llegó el corte a tu mesa.
            </p>
          </Reveal>
        </div>
