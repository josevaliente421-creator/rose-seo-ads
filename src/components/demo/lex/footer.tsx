      ...
      <DemoContainer className="py-16 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr_1fr] lg:gap-20">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-white/50">
              La estrategia legal que protege el futuro de tu empresa.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm text-white/60">
              <li className="flex items-start gap-2.5">
                ...
                Av. Apoquindo 4800, piso 11 · Santiago
              </li>
              <li>
                <a
                  href="mailto:hola@lexabogados.cl"
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-8 sm:flex-row">
          <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-white/30">
            © {new Date().getFullYear()} LEX Abogados · Sitio demostrativo
          </p>
          <a
            href={site.url}
