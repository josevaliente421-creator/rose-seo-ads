        ...
        <div className="max-w-2xl">
          ...
          <Reveal delay={0.1}>
            <h2 className="mt-6 font-demo-serif text-4xl font-semibold leading-[1.08] tracking-tight sm:text-5xl">
              Cinco pasos,{" "}
              <span className="italic text-[#4a1025]">una sola dirección</span>
            </h2>
          </Reveal>
        </div>
          ...
          <ol className="relative hidden lg:grid lg:grid-cols-5 lg:gap-8">
            <li aria-hidden className="absolute inset-x-0 top-0 h-px bg-[#1a0b10]/12">
              <motion.span
                ...
                className="block h-full origin-left bg-gradient-to-r from-[#4a1025] to-[var(--demo-gold)]"
              />
            </li>
            {processSteps.map((step, i) => (
              ...
              >
                <span
                  aria-hidden
                  className="absolute left-0 top-0 flex size-8 items-center justify-center rounded-full border border-[#4a1025]/30 font-mono text-[11px] font-medium text-[#4a1025]"
                >
                  {i + 1}
                </span>
                ...
                <p className="mt-2.5 text-sm leading-relaxed text-[#4a1025]/65">
                  {step.description}
                </p>
              </motion.li>
            ))}
          ...
          <ol className="relative space-y-10 border-l border-[#1a0b10]/12 pl-8 lg:hidden">
            <li aria-hidden className="absolute inset-y-0 -left-px w-px">
              <motion.span
                ...
                className="block h-full origin-top bg-gradient-to-b from-[#4a1025] to-[var(--demo-gold)]"
              />
            </li>
            {processSteps.map((step, i) => (
              <motion.li
              ...
              >
                <span
                  aria-hidden
                  className="absolute -left-[2.72rem] top-0 flex size-8 items-center justify-center rounded-full border border-[#4a1025]/30 bg-[var(--demo-paper)] font-mono text-[11px] font-medium text-[#4a1025]"
                >
                  {i + 1}
                </span>
                <h3 className="font-demo-serif text-2xl font-semibold tracking-tight">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#4a1025]/65">
                  {step.description}
                </p>
              </motion.li>
            ))}
